...
inCity.cssParents = function(){ //城市显示
    inCity.top = placeThis.offset().top+32;  //城市选择框  top位置
    inCity.left = placeThis.offset().left;   //城市选择框  left位置
    inCity.width = placeThis.width() + 3;
...
inCity.allCity = ['北京|b|b','上海|shanghai|s', '重庆|chongqing|cq',  '深圳|shenzhen|sz', '广州|guangzhou|gz', '杭州|hangzhou|hz',
...
inCity.cityClick = function ($this) {
    $(".city_a_le1 a").mousedown(function () {
